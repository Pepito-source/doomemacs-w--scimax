...
(setq! scimax-manuscipt-templates "~/.config/ox-manuscript/ox-manuscript-templates")
(defcustom ox-manuscript-user-template-dir
  (file-name-as-directory (expand-file-name "ox-manuscript-templates" scimax-manuscipt-templates))
